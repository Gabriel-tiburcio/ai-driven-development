        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Activities_Hotels_HotelId",
                        column: x => x.HotelId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelStaffUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HotelStaffUsers_Hotels_HotelId",
                        column: x => x.HotelId,
                        principalTable: "Hotels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChargeToRoom = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_ActivitySlots_SlotId",
                        column: x => x.SlotId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelStaffUsers_Email",
                table: "HotelStaffUsers",
                column: "Email",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_HotelStaffUsers_HotelId",
                table: "HotelStaffUsers",
                column: "HotelId");
